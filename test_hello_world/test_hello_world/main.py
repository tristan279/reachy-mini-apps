    ...
    def speak(self, text: str) -> None:
        ...
        try:
            ...
            try:
                ...
                log_print(f"AWS Polly failed: {e}, this is expected if AWS credentials are not configured", "WARNING")
                log_print("Falling back to local TTS generation...", "WARNING")
                # Fallback: could add gTTS here if needed, but for now just raise
                raise
